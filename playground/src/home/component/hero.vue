...
.hero-copy h1 {
  ...
  margin: 0;
  font:
    400 clamp(57px, 5.5vw, 88px)/0.95 'DM Serif Display',
    Georgia,
    serif;
...
.portrait-halo {
  ...
  background: radial-gradient(
    circle,
    rgba(174, 164, 228, 0.45),
    rgba(174, 164, 228, 0) 69%
  );
  filter: blur(27px);
}
...
.portrait-paper {
  ...
  box-shadow: 0 14px 34px rgba(39, 42, 68, 0.12);
  font:
