// @ffm/parser/src/type.ts
import type { LinkMatch } from '@ffm/linkify';
...
export interface BlockRule {
  name: string;
  // optional marker to quickly identify potential matches (e.g., '#' for headings)
  marker: string[];
...
export interface MarkdownParserOption {
