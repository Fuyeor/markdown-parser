 ...
 */
export const social = `
I'm currently focused on refining the benchmarking process for **@ffm/parser**.

I've initiated *memory* and *speed tests*, using files like \`@ffm/benchmark/memory.ts\` and \`@ffm/benchmark/speed.ts\`.
